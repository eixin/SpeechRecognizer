...
{
  /** Zero constant */
  final static public double ZERO=0d;
  final static public double PI = 3.141592653589793238d;
  /** Pi/2 constant */
  final static public double PIdiv2=PI / 2;
  /** Pi/4 constant */
  final static public double PIdiv4=PIdiv2 / 2;
  /** Pi/6 constant */
  final static public double PIdiv6=PIdiv2 / 3;
  /** Pi/12 constant */
  final static public double PIdiv12=PIdiv6 / 2;
  /** Pi*2 constant */
  final static public double PImul2=PI * 2;
  /** Pi*4 constant */
  final static public double PImul4=PI * 4 ;
